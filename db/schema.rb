...
ActiveRecord::Schema.define(version: 20160315102134) do
  ...
  add_index "data_sets", ["solution_id"], name: "index_data_sets_on_solution_id", using: :btree
  ...
  add_index "file_uploadeds", ["uploadable_type", "uploadable_id"], name: "index_file_uploadeds_on_uploadable_type_and_uploadable_id", using: :btree
  ...
  add_foreign_key "data_sets", "solutions"
